...
variable "argo_cd_virtual_service_host" {
  type        = string
  description = "The hostname for the Argo cd virtual service, used for advanced deployment capabilities like canary and blue-green deployments in Kubernetes."
  default     = "argo-cd.k8s.raj.ninja"
}

variable "argo_cd_ingress_internal" {
  type        = bool
